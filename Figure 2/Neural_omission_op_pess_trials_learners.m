base_path = 'C:\';
figname = 'Neural_omission_op_pess_trials_learners';
in_t  = BigT;
rm = 1;
data_int = 153:212;
bar_int = 163:212;
...
select_mice_list = {};
exclude_mice_list = {};  % has no optimistic trial 6 so need to exclude for per mouse but not per line
...
if exist("data2_t") == 1
    ...
    formula = 'newData ~ LMEcat + TrialType + (1|MouseID) + (1|MouseID:SiteNum)' ;
