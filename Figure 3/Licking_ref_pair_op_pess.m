% [BigT_match, BehT_match, pairInfo] = match_mouse_pairs_concat(BigT(BigT.TrainingType == 4,:), BehT(BehT.TrainingType == 4,:));
base_path = 'C:\';
figname = 'Licking_ref_pair_op_pess';
...
legend_names = {'OpRef','PessRef','OpPaired','PessPaired'};
x_label =  'Time (s)';
y_label = '\Delta Z';
num_data = 4;
font_size = 28;
...
[data1_t] = filter_BigT_match(in_t, exclude_raw_n,  TrainingT,TrialT,lick_discrim_thresh,lick_discrim_cat,neural_discrim_thresh,neural_discrim_cat,lick_discrim_thresh_posodor,lick_discrim_cat_posodor,neural_discrim_thresh_posodor,neural_discrim_cat_posodor,lick_discrim_thresh_negodor,lick_discrim_cat_negodor,neural_discrim_thresh_negodor,neural_discrim_cat_negodor,op_pess_mice,skew_thresh,op_pess_trials,op_pess_trials_paired,licking_filter,lick_filter_int,select_mice_list,exclude_mice_list);
...
TrialT = [5:10];
op_pess_trials = 'pess';
[data2_t] = filter_BigT_match(in_t, exclude_raw_n,  TrainingT,TrialT,lick_discrim_thresh,lick_discrim_cat,neural_discrim_thresh,neural_discrim_cat,lick_discrim_thresh_posodor,lick_discrim_cat_posodor,neural_discrim_thresh_posodor,neural_discrim_cat_posodor,lick_discrim_thresh_negodor,lick_discrim_cat_negodor,neural_discrim_thresh_negodor,neural_discrim_cat_negodor,op_pess_mice,skew_thresh,op_pess_trials,op_pess_trials_paired,licking_filter,lick_filter_int,select_mice_list,exclude_mice_list);
...
TrialT = [5:10];
op_pess_trials = 'All';
op_pess_trials_paired = 'op';
[data3_t] = filter_BigT_match(in_t, exclude_raw_n,  TrainingT,TrialT,lick_discrim_thresh,lick_discrim_cat,neural_discrim_thresh,neural_discrim_cat,lick_discrim_thresh_posodor,lick_discrim_cat_posodor,neural_discrim_thresh_posodor,neural_discrim_cat_posodor,lick_discrim_thresh_negodor,lick_discrim_cat_negodor,neural_discrim_thresh_negodor,neural_discrim_cat_negodor,op_pess_mice,skew_thresh,op_pess_trials,op_pess_trials_paired,licking_filter,lick_filter_int,select_mice_list,exclude_mice_list);
...
TrialT = [5:10];
op_pess_trials = 'All';
op_pess_trials_paired = 'pess';
[data4_t] = filter_BigT_match(in_t, exclude_raw_n,  TrainingT,TrialT,lick_discrim_thresh,lick_discrim_cat,neural_discrim_thresh,neural_discrim_cat,lick_discrim_thresh_posodor,lick_discrim_cat_posodor,neural_discrim_thresh_posodor,neural_discrim_cat_posodor,lick_discrim_thresh_negodor,lick_discrim_cat_negodor,neural_discrim_thresh_negodor,neural_discrim_cat_negodor,op_pess_mice,skew_thresh,op_pess_trials,op_pess_trials_paired,licking_filter,lick_filter_int,select_mice_list,exclude_mice_list);
...
if exist("data2_t") == 1
    ...
    newT.TrialTypeGrp = categorical(newT.TrialType);   % start from original
    
    % Merge 5 and 8 into one category (label it '5or8' or whatever you like)
    newT.TrialTypeGrp = mergecats(newT.TrialTypeGrp, {'5','8'}, '5or8');
    
    % Merge 6 and 9
    newT.TrialTypeGrp = mergecats(newT.TrialTypeGrp, {'6','9'}, '6or9');
    
    % Merge 7 and 10
    newT.TrialTypeGrp = mergecats(newT.TrialTypeGrp, {'7','10'}, '7or10');

    formula = 'newData ~ LMEcat + TrialTypeGrp + (1|MouseID) + (1|Pair_Num)' ; % changed to TrialTypeGrp on 2/17/26
    % newT.New_Bias_2perside = categorical(newT.New_Bias_2perside);
    mdl = fitlme(newT,formula,'DummyVarCoding','reference')
    anova(mdl)
    
    coefTest(mdl,[0 0 0 1 0 0])
    coefTest(mdl,[0 0 0 0 1 0])
    coefTest(mdl,[0 0 0 1 0 -1])
...
estimates = [C.Estimate(7:9);out.estimate] % first is intercept
SE_all = [C.SE(7:9);out.se] % first is intercept
