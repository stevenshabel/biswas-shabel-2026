base_path = 'C:\';
figname = 'Neural_op_pess_trials_learners_ind_tone';

BigT.TrialTypeGrp = BigT.TrialType;
x = string(BigT.TrialTypeGrp);
...
BigT.TrialTypeGrp = categorical(x);
...
errors = [1 1 1]; % 1 row vector of errors from LME
% ******************************************************************
