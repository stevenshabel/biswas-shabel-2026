base_path = 'C:\';
figname = 'Licking_op_pess_trials_nonlearners_ind_tone';
in_t  = BehT;
rm = 1;
data_int = 126:162;
bar_int = 131:162;
...
legend_names = {'Op','Pess','Odor only'};
x_label =  'Time (s)';
y_label = '\Delta Z';
num_data = 3;
font_size = 28;
...
d_colormap = [d1_color;d2_color;d3_color];
linewidth = 6;
linestyle = '-';
